...
<section class="descr">
	<p>Description</p>
	<h1>LEVIS</h1>
<h1>Acid Washed Panelled Denim Slim Shirt</h1>
	<ul>
		<li>* Slim Fit
<li>* Curved hemline
<li>* Buttoned flap pockets
<li>* 100% Cotton
<li>* Single-button round cuffs
<li>* Machine wash cold
<li>* Product Code: 460399058003
</ul>
<h2>Final Price: $150</h2>
...
<button class="buy" onclick="window.location.href='buy_mens_shirt_s1.php'">Buy</button>
</section>
<section class="revi">
