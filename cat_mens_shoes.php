...
<html>
<head>
	<title>categories_shoes Mens</title>
...
<section class="shirts">
	<div class="s1001">
	<img src="https://images-na.ssl-images-amazon.com/images/I/91F4PENHf%2BL._UX500_.jpg">
	<h1>Woodland shoe</h1>
	<h1>$200</h1>
	...
	<div class="s1002">
	<img src="https://images.unsplash.com/photo-1570464197285-9949814674a7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=666&q=80">
	<h1>Nike mens denim sneakers</h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
	...
	<div class="s1003">
	<img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80">
	<h1>Nike sports</h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1004">
	<img src="https://db3ujbgzkl8k8.cloudfront.net/catalog/product/thumbnail/9a9b60a8ae77a5b6e5d880774535628a/image/700x700/000/80/x/a/xabi_alonso_signed_black_adidas_boot_with_metal_studs_2_2_1.png">
	<h1>Addidas sports sturds</h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1005">
	<img src="https://images.puma.net/images/193249/05/sv01/fnd/PNA/">
	<h1>Puma </h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1006">
	<img src="https://www.jeans24h.eu/images/381100879_main.jpg">
