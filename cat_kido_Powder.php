...
<p><a href="proj.php">Home</a> > Kido > Cosmetics > Baby-Powder</p>
...
<section class="shirts">
	...
	<div class="s1001">
	<img src="https://images-na.ssl-images-amazon.com/images/I/51EmUgM0%2BjL._SX679_.jpg">
	<h1>Johnson baby Powder  </h1>
	<h1>$40</h1>
	...
	<div class="s1002">
	<img src="https://cdn.fcglcdn.com/brainbees/images/products/zoom/2652109a.jpg">
	<h1>Baby himalaya herbal Powder </h1>
	<h1>$55</h1>
	<button>Add to cart</button>
	<button>Buy</button>
	...
	<div class="s1003">
	<img src="https://images-na.ssl-images-amazon.com/images/I/31Q1TffINKL._SX466_.jpg">
	<h1>Johnson baby Powder s</h1>
	<h1>$100</h1>
	<button>Add to cart</button>
	<button>Buy</button>
	...
	<div class="content">
		...
		<i>Baby powder is an astringent powder used for preventing diaper rash and for cosmetic uses. It may be composed of talcum (in which case it is also called talcum powder) or corn starch. Baby powder can also be used as a dry shampoo, cleaning agent (to remove grease stains), and freshener.
...
<BR>
Some studies have found a statistical relationship between talc applied to the perineal area by women and incidence of ovarian cancer, but there is not a consensus that the two are linked.In 2016, more than 1,000 women in the United States sued[8] Johnson & Johnson for covering up the possible cancer risk associated with its baby powder. The company stopped selling talcum powder in the United States and Canada in 2020.
		</i>
...
<div class="inner">
<img src="https://n3.sdlcdn.com/imgs/f/m/w/Himalaya-Combo-Cream-200ml-Baby-SDL504294172-1-2f7f3.jpeg">
<h4>Combo of 3 only for $250.</h4>
