...
<section class="descr">
	<p>Description</p>
	<h1>High-waisted faded light blue skinny jeans</h1>
<h1></h1>
	<ul>
		<li>* High-waisted light blue cotton skinny jeans</li>
<li>* Concealed button </li>
<li>* zipper fly, six pockets</li> 
<li>* frayed leg bottoms, belt loops</li>
<li>* With cute applique character detailing </li> 
<li>* Nickel-free poppers to protect against irritation.</li>
<br>
</ul>
<h2>Final Price: $1220</h2>
...
<button class="buy" onclick="window.location.href='buy_woman_j1.php'">Buy</button>
</section>
<section class="revi">
