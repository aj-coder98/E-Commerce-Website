...
<section class="shirts">
	<div class="s1001">
	<img src="https://www.americanjeans.com/images/accessories/levis-a-11lv0204-brown.jpg">
	<h1>American Levis Mens Belt</h1>
	<h1>$50</h1>
	<button>Add to cart</button>
	<button>Buy</button>
	</div>
	<div class="s1002">
	<img src="https://i.ebayimg.com/thumbs/images/g/z0AAAOSwoyleakwO/s-l225.jpg">
	<h1>Raddish Brown Levis belt </h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
	...
	<div class="s1003">
	<img src="https://images-na.ssl-images-amazon.com/images/I/818Lr0lYnDL._UX679_.jpg">
	<h1>U.SPolo.Assa. Mens Belt</h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1004">
	<img src="https://rukminim1.flixcart.com/image/714/857/jgpfs7k0/belt/u/e/5/38-inches-bt-1059041-bt-1059041-belt-woodland-original-imaf4vwfgmk8agxk.jpeg?q=50">
	<h1>Woodland Mens Casual belt</h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1005">
	<img src="https://www.allingolfer.com/content/images/thumbs/0000844_nike-mens-cutout-and-cutout-ii-belts-2-pack.jpeg">
	<h1>NIKE Mens Belt</h1>
	<h1>$200</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1006">
	<img src="https://images-na.ssl-images-amazon.com/images/I/81i10Y%2BXG3L._UX679_.jpg">
	<h1>Peter England Mens Belt</h1>
	<h1>$200</h1>
	<button>Add to cart</button>      
	<button>Buy</button>
...
<div class="inner">
<img src="https://i.pinimg.com/originals/2c/53/ed/2c53ed09ff2ae9fd69a190fb5faebbb5.png">
<h4>Vintage Collection Comming Soon</h4>
