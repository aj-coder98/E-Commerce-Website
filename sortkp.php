...
<h3>Search Results</h3>
	...
	<?php
         	...
         	$sql = "SELECT * FROM product WHERE UPPER(name) LIKE UPPER('%$Search%') OR  UPPER(p_type) LIKE UPPER('%$Search%') HAVING category LIKE 'kids' ORDER BY price";
         	$result = mysqli_query($conn, $sql);
         	$queryResults = mysqli_num_rows($result);

         	if($queryResults > 0){
               echo "<h3> There are following results: </h3>";
         		echo"<h2> Categorize By : &nbsp; <a href ='sortk.php? search=".$Search."' style='text-decoration: none;'> Kids &nbsp; </a> <a href='sortkp.php? search=".$Search."' style='text-decoration: none;'> Price &nbsp; </a> </h2>" ; 
