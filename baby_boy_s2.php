...
<section class="box">
	<p>Products</p>
	<section id="fix" class="pic10">

	</section>
	<section id="fix" class="pic11">
		
	</section>
	<section id="fix" class="pic12">
...
<h1>And Leggings Set</h1>
	<ul>
		<li>*Featuring stretchy denim dungarees</li>
		<li>* With cute applique character detailing </li> 
		<li>* Nickel-free poppers to protect against irritation.</li>
<li>* Machine washable.</li>
<li>* Dungaree Main 80% Cotton, 19% Polyester</li> 
<li>* 1% Elastane. Lining 65% Polyester, 35% Cotton. Bodysuit 100% Cotton.</li>
...
<button class="buy" onclick="window.location.href='buy_babys2.php'">Buy</button>
</section>
<section class="revi">
