...
<p><a href="proj.php">Home</a> > Kido > Cosmetics > Baby-soap</p>
...
<section class="shirts">
	...
	<div class="s1001">
	<img src="https://images-na.ssl-images-amazon.com/images/I/71v-7ORABOL._SL1500_.jpg">
	<h1>Johnson baby soap  </h1>
	<h1>$20</h1>
	...
	<div class="s1002">
	<img src="https://images-na.ssl-images-amazon.com/images/I/31aF5AVvFkL._SX466_.jpg">
	<h1>Baby Dove soap </h1>
	<h1>$15</h1>
	<button>Add to cart</button>
	<button>Buy</button>
	...
	<div class="s1003">
	<img src="https://static2.medplusmart.com/products/SANT0029_L.jpg">
	<h1>Santoor baby soap</h1>
	<h1>$100</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1004">
	<img src="https://www.pepstores.com/cdn-proxy/cdn_pepstores_com/product-images/prod/370_370_AGT35_web_PNG.webp">
	<h1>Johnsonh baby soap</h1>
	<h1>$30</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    </div>
    ...
    <div class="s1005">
	<img src="https://rukminim1.flixcart.com/image/312/312/k6jnfrk0/soap/k/c/h/6-450-gentle-baby-soap-6n-x-75g-himalaya-original-imafzzgxhdjybemj.jpeg?q=70">
	<h1>Himalaya Baby soap</h1>
	<h1>$10</h1>
	<button>Add to cart</button>
	<button>Buy</button>
    ...
    <div class="s1006">
	<img src="https://www-konga-com-res.cloudinary.com/w_auto,f_auto,fl_lossy,dpr_auto,q_auto/media/catalog/product/F/M/158085_1563792919.jpg">
	<h1>Cussons baby soap</h1>
	<h1>$15</h1>
	<button>Add to cart</button>      
	<button>Buy</button>
